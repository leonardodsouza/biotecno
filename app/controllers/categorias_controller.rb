class CategoriasController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @categoria.update(categoria_params)
        format.html { redirect_to home_path, notice: 'Categoria was successfully updated.' }
  ...
  private
    ...
    def categoria_params
      params.require(:categoria).permit(:nome,:img, :ordem, :descricao, :classe, :titulo, :texto)
    end
end
